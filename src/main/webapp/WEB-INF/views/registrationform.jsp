...
<form:label path="user.mobilenumber">Enter Mobilenumber</form:label>
<form:input path="user.mobilenumber" id="user.mobilenumber" type="mobilenumber"/>
<form:label path="user.username">Enter Username</form:label>
<form:input path="user.username" id="user.username" type="username"/>
